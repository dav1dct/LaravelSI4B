  ...
  <div class="container-scroller d-flex">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" data-toggle="collapse" href="{{ url('#ui-basic')}}" aria-expanded="false" aria-controls="ui-basic">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('pages/tables/basic-table.html')}}">
            <i class="mdi mdi-grid-large menu-icon"></i>
            <span class="menu-title">Tables</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('pages/icons/mdi.html')}}">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{ url('index.html')}}"><img src="{{ url('images/logo.svg')}}" alt="logo"/></a>
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown mr-1">
              <a class="nav-link count-indicator dropdown-toggle d-flex justify-content-center align-items-center" id="messageDropdown" href="{{ url('#')}}" data-toggle="dropdown">
            ...
            <li class="nav-item dropdown mr-2">
              <a class="nav-link count-indicator dropdown-toggle d-flex align-items-center justify-content-center" id="notificationDropdown" href="{{ url('#')}}" data-toggle="dropdown">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="{{ url('#')}}" data-toggle="dropdown" id="profileDropdown">
                ...
                <span class="nav-profile-name">dav1dct</span>
              </a>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                ...
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Distributed By: <a href="{{ url('https://www.themewagon.com/')}}" target="_blank">ThemeWagon</a></span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free <a href="{{ url('https://www.bootstrapdash.com/')}}" target="_blank">Bootstrap dashboard templates</a> from Bootstrapdash.com</span>
              </div>
            </div>
          </div>
        </footer>
